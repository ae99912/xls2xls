...
/*
 * Копирование из ячеек, заданных картой, непустых значений из входного в выходной лист Excel 2010
 * ячейки задаются картой переноса.
 *   # пример карты
 *   C53:F56
 *   D51
 *
...
public class Main {
  ...
  private final static String HelpMessage =
      ...
      "-df format   формат даты для выходной ячейки https://clk.li/zTV\n" +
      "\n" +
      "Копирование из ячеек, заданных картой, непустых значений из входного в выходной лист.\n" +
      "Cпец. обработка (свойства) - в последующие ячейки копируем:\n" +

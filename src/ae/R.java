...
/*
 ...
 07.07.26 если задан паттерн, то применимы any (любые, в том числе пустые) значения
 07.07.26 добавил свойства: @01 (0-1), @02 (0-2), @_01 (пустое или 0-1), @_02 (пустое или 0-2)
 09.07.26 изменил свойства @012 и @_012, отладка подробного вывода формулы при чтении ячейки
 11.07.26 подробный вывод ячеек не соответствующих паттерну
 11.07.26 при вставке строки явно задать тип выходной ячейки

*/

public class R {
    public final static String Ver = "v.11.2";  // номер версии
